Feature: As a user I can interact with text areas
  ...
  @smoke
  @regression
  Scenario: As a user I can interact and assert on text ares
    ...
    And I fill in the "textarea" input with "Learning to input into text areas"
    And the "textarea" should contain the value "Learning to input into text areas"